<script lang="ts">
  ...
  console.log(data)
  let src: string = "https://images.clutch.ca/image/upload/f_auto/t_extra_small/v1/production/bfceea9f-9a9e-45a7-8e07-928ecd7dbf9a?_a=ATFGlAA0"
</script>
...
<div class="w-full max-w-sm bg-white rounded-lg  dark:bg-gray-800 dark:border-gray-700 ">
  ...
  <div class="px-5 pb-5">
      <a href="#">
          <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">2017 Subaru Forester</h5>

    
      <div class="flex items-center justify-between">
          <span class="text-sm font-md text-gray-500 dark:text-white">$24,599</span>
          <span class="text-sm font-md text-gray-500 dark:text-white">100,000km</span>
